...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("due_sms", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>due_sms">
					<i class="menu-icon fa fa-comment"></i>
					<span class="menu-text"> Send Due SMS  </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("material_sale", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>material_sale">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Material Sale </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("material_sales_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>material_sales_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Material Sales Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			|| array_search("material_sales_invoices", $access) > -1
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("material_sales_invoices", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>material_sales_invoices">
								<i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'ReportsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			|| array_search("material_sales_record", $access) > -1
			|| array_search("returnList", $access) > -1
			|| array_search("customerDue", $access) > -1
			|| array_search("customerPaymentReport", $access) > -1
			|| array_search("customer_payment_history", $access) > -1

        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="due_sms" v-model="access"> Send Due SMS</li>
                    <li><input type="checkbox" class="access" value="salesrecord" v-model="access"> Sales Record</li>
                    <li><input type="checkbox" class="access" value="material_sale" v-model="access"> Material Sale</li>
                    <li><input type="checkbox" class="access" value="material_sales_record" v-model="access"> Material Sales Record</li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="material_sales_invoices" v-model="access"> Material Sales Invoice</li>

				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr v-for="due in dueList">
							...
							<td style="text-align:right;">{{ due.bill }}</td>
							<td style="text-align:right;">{{ due.material_bill }}</td>
							<td style="text-align:right;">{{ due.paid }}</td>
							<td style="text-align:right;">{{ due.returned }}</td>
							<td style="text-align:right;">{{ due.cashReceived }}</td>
							<td style="text-align:right;">{{ due.due }}</td>
						</tr>
					</tbody>
					<tbody>

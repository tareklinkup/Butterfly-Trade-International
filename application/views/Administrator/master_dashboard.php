				...
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url(); ?>" class="navbar-brand">
						<small>
							...
							<!--Enterprise Resource Planning--><?php //echo $companyInfo->Company_Name;?> <?php echo $this->session->userdata('Brunch_name'); ?> <span style="color:#000;font-weight:700;letter-spacing:1px;font-size:16px;"> <?php //echo $this->session->userdata('Brunch_name'); ?> </span>
						</small>
					</a>
				</div>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							...
							<span style="font-weight: bold; color: #972366; font-size: 16px;">
								<?php $branch_logo =base_url().'uploads/company_profile_org/'.$this->session->userdata('Brunch_image'); ?>

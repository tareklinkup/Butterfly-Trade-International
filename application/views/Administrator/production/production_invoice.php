                ...
                <div class="row">
                    <div class="col-xs-6">
                        <table class="details-table">
                            <tr>
                                <td colspan="2" style="text-align:center;font-weight:bold;font-size:15px;">Materials</td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-xs-6">
                        <table class="details-table">
                            <tr>
                                <td colspan="2" style="text-align:center;font-weight:bold;font-size:15px;">Products</td>
                            </tr>
                            <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        <table class="info-table">
                            ...
                            <tr><td>Transport Cost</td><td>&nbsp;:&nbsp;</td><td style="text-align:right;">{{ production.transport_cost }}</td></tr>

                            ...
                            <div class="col-sm-12">
                                <form id="materialForm" v-on:submit.prevent="addToCart">
                                    <div class="form-group clearfix clearfix">
                                        ...
                                        <div class="col-sm-8">
                                            <v-select label="name" v-bind:options="materials" v-model="selectedMaterial" placeholder="Select Material" v-on:input="setFocus();getMaterialStock()"></v-select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix clearfix">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" ref="quantity" required class="form-control" placeholder="Quantity" v-model="selectedMaterial.quantity"/> 
                                        </div>
                                    ...
                                    <div class="form-group clearfix" style="display:none;">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" required class="form-control" placeholder="Quantity" v-model="selectedMaterial.purchase_rate" />
                                        </div>
                                    </div>
                    ...
                    <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                        ...
                        <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                            <tr v-for="(material, sl) in cart">
                                ...
                                <td><a href="" v-on:click.prevent="removeFromCart(material)"><i class="fa fa-trash fa-2x"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="col-sm-12">
                                <form id="productForm" v-on:submit.prevent="addToProductCart">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Quantity" ref="productQuantity" v-model="selectedProduct.quantity" required>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix" style="display: none;">
                                        <label class="col-sm-4 control-label">Price</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" v-model="selectedProduct.Product_Purchase_Rate">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="col-sm-4 control-label"></label>
                    ...
                    <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                        ...
                        <tbody style="display:none;" v-bind:style="{display: cartProducts.length > 0 ? '' : 'none'}">
                            <tr v-for="(product, sl) in cartProducts">
                                ...
                                <td><a href="" v-on:click.prevent="removeFromProductCart(product)"><i class="fa fa-trash fa-2x"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <div class="widget-main">
                        <form v-on:submit.prevent="saveProduction">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" v-model="production.material_cost" v-on:input="calculateTotal">
                                </div>
                            </div>
                            <div class="form-group clearfix">
                            ...
                            <div class="form-group clearfix">
                                <label class="col-sm-12 control-label">Transport Cost</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" v-model="production.transport_cost" v-on:input="calculateTotal">
                                </div>
                            </div>
                            <div class="form-group clearfix">
    ...
    new Vue({
        ...
        methods: {
            ...
            addToCart(){
                ...
                if(ind > -1){
                    this.cart[ind].quantity = parseFloat(this.selectedMaterial.quantity);
                    this.cart[ind].total = parseFloat(this.cart[ind].quantity) * parseFloat(this.cart[ind].purchase_rate);
                } else {
                    this.selectedMaterial.total = parseFloat(this.selectedMaterial.quantity) * parseFloat(this.selectedMaterial.purchase_rate);
                    let material = Object.assign({}, this.selectedMaterial);
            ...
            addToProductCart(){
                ...
                // } else {
                    ...
                    if(this.cartProducts.length==1){
                        alert('sorry you can\'t add  production  product one more...');
                        return false;
                    }
            ...
            calculateTotal(){
                this.production.material_cost = this.cart.reduce((p, c) => { return p + parseFloat(c.total) }, 0);
                this.production.total_cost = 
                    parseFloat(this.production.material_cost) +
                    parseFloat(this.production.labour_cost) +
                    parseFloat(this.production.transport_cost) +
            ...
            saveProduction(){
                ...
                this.cartProducts[0].price =  this.production.total_cost/this.cartProducts[0].quantity

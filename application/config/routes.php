...
$route['get_reguler_lot_stock'] = 'Administrator/Products/getRegulerLotStock';
$route['get_production_lot_stock'] = 'Administrator/Products/getProductionLotStock';
...
$route['delete_previous_purchase'] = 'Administrator/Purchase/deletePreviousPurchase';
$route['check_original_sold_qty'] = 'Administrator/Purchase/checkOriginalSoldQty';
...
//Material Sale
$route['material_sale'] = 'Administrator/MaterialSale';
$route['material_sale/(:any)'] = 'Administrator/MaterialSale/editSale/$1';
$route['add_material_sale'] = 'Administrator/MaterialSale/addSales';
$route['update_material_sale'] = 'Administrator/MaterialSale/updateSales';
$route['get_material_sales'] = 'Administrator/MaterialSale/getSales';
$route['material_sale_invoice/(:any)'] = 'Administrator/MaterialSale/invoice/$1';
$route['material_sales_record'] = 'Administrator/MaterialSale/salesRecord';
$route['get_material_sales_record'] = 'Administrator/MaterialSale/getSalesRecord';
$route['get_material_sale_details'] = 'Administrator/MaterialSale/getSaleDetails';
$route['delete_material_sale'] = 'Administrator/MaterialSale/deleteSale';
$route['material_sales_invoices'] = 'Administrator/MaterialSale/salesInvoices';

// Customer Due SMS
$route['due_sms'] = 'Administrator/Customer/DueSms';
$route['send_due_sms'] = 'Administrator/Customer/SendDueSms';
